...
<p align="center">
  <img src="assets/screenshots/screenshot-churn-dashboard.png" alt="Métricas del Modelo e Importancia de Variables" width="48%" style="border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);" />
  <img src="assets/screenshots/screenshot-churn-simulator.png" alt="Simulador Interactivo de Riesgo de Abandono" width="48%" style="border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);" />
</p>
